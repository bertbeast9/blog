...
headcol1, headcol2, headcol3 = st.columns([1,1,1])
with headcol2:
    st.image("./src/figures/sam.bertelson_gmail.com-0966f250-edited.jpg", caption = "As seen on my mother's fridge", width = 250)
